...
class RealStatePhotoController extends Controller
{
    ...
    public function setThumb($photoId, $realStateId)
    {
        ...
        try{
            ...
            //seleciona a foto que tem thumb == true e passa para false
    ...
    public function remove($photoId)
    {
	    try {
		    ...
		    if($photo->is_thumb) {
			    $message = new ApiMessage('Não é possivel remover foto de thumb, selecione outra thumb e remova a imagem desejada!');
			    return response()->json($message->getMessage(), 401);
            }
